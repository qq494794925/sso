...
class Client {
    ...
    public function getTicket() {
        return !empty($_COOKIE[$this->_cookiePre . self::TICKET_COOKIE_NAME]) ? $_COOKIE[$this->_cookiePre . self::TICKET_COOKIE_NAME] : '';
    }

    public function getUsername() {
        return !empty($_COOKIE[$this->_cookiePre . self::USER_COOKIE_NAME]) ? $_COOKIE[$this->_cookiePre . self::USER_COOKIE_NAME] : '';
    }
